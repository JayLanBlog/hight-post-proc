...
private:
    ...
    // Deferred destruction queues (resources to destroy after GPU fence signals done)
    ...
    std::vector<DeferredTexDestroy> m_deferredTexDestroys;

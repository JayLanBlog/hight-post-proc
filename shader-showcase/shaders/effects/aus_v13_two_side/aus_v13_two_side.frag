...
void main() {
    ...
    vec3 frontCol = vec3(uParamFloat0, uParamFloat1, uParamFloat2);
    vec3 backCol = vec3(uParamFloat3, uParamFloat4, 0.5);
    vec3 col = facing > 0.0 ? frontCol : backCol;
    outColor = vec4(col, uParamFloat5);
}

...
void main() {
    ...
    vec3 ambient = tex.rgb * uParamFloat0;
    vec3 diffuse = tex.rgb * uLightColor * NdotL * uParamFloat1;
    vec3 specular = uLightColor * pow(NdotH, uParamFloat2 * 64.0) * uParamFloat3;

...
void main() {
    ...
    rim = pow(rim, uParamFloat0);
    vec3 rimColor = vec3(uParamFloat1, uParamFloat2, uParamFloat3);
    vec3 base = vec3(0.2, 0.25, 0.35);
    outColor = vec4(base * uLightColor * (NdotL+0.2) + rimColor*rim, 1.0);
}

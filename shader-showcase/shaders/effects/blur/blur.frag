...
void main() {
    ...
    // Gaussian blur with radius-controlled kernel size
    vec2 texelSize = 1.0 / uResolution;
    vec3 result = vec3(0.0);
    float total = 0.0;
    
    // Radius controls blur spread (sigma and sample offset)
    ...
    // Strength controls blend between original and blurred (0 = original, 1 = fully blurred)

#version 460
// Vol.05-22 Glass v2: Blend One One + cubemap reflection
// Reference: Material Diffuse[_Color], Lighting On, SetTexture[_Reflections]{combine texture}
// combine texture replaces vertex lighting with cubemap texture, Blend One One additive
...
void main(){
    ...
    vec3 R=reflect(-V, N);
    // Procedural cubemap reflection: skybox replacement
    ...
    // Blend One One: output = reflection color (combine texture replaces vertex lighting)

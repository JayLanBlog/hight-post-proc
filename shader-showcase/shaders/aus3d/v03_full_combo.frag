#version 460
// Vol.03-11 Full combo: vertex light + emission + dual texture blend
...
void main(){
    ...
    vec3 tex2=vec3(hash(suv*100.0+0.0),hash(suv*100.0+1.0),hash(suv*100.0+2.0));
    float ndl=dot(N,L)*0.5+0.5;
    vec3 emissive=vec3(P0,P1,P2)*P3;
    vec3 blend=mix(tex1,tex2,0.5);
    outColor=vec4(blend*ndl*uLightColor+emissive,1);
}
...
| ![Bloom](screenshots/detail_01.png) | ![Glitch](screenshots/detail_12.png) |
|:---:|:---:|
| *泛光 — 城市夜景* | *故障艺术 — 数字撕裂* |

| ![Toon](screenshots/detail_13.png) | ![VHS](screenshots/detail_14.png) |
|:---:|:---:|
| *卡通着色 — 赛璐珞风格* | *VHS 复古 — 噪点扫线* |

| ![CRT](screenshots/detail_15.png) | ![Water Ripple](screenshots/detail_16.png) |
|:---:|:---:|
| *CRT 显示器 — RGB 荧光点* | *水波纹 — 法线贴图位移* |
...
| `F1` ~ `F8` | 快速选择第 1-8 个特效 |
| `Ctrl+1` / `Ctrl+2` | 切换渲染后端 (OpenGL ↔ Vulkan) |
| `F12` / `Ctrl+S` | 保存当前画面截图 |
| `Ctrl+O` | 加载外部图片文件 |
| `Ctrl+V` | 切换到视频素材输入 |
